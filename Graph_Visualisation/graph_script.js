...
// Define color scales for normal and highlight states based on predefined categories
    ...
    function showDetails(event, d) {
        ...
        if (d.type === "main") {
            ...
            const themeTexts = {
                "self-stigma": "<h3>Self-Stigma</h3><p>Self-stigma occurs when individuals internalize negative stereotypes and attitudes about their condition, leading to feelings of shame and decreased self-esteem. This can significantly affect their mental health and willingness to seek help.</p>",
